...
Foi adotado um modelo de degradação equivalente para converter níveis de severidade em uma escala temporal de operação, permitindo a aplicação de técnicas clássicas de confiabilidade. Os resultados devem ser interpretados como uma análise comparativa sob hipóteses de degradação modeladas e não como tempos reais de falha.
